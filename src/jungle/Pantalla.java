    ...
    public static void main(String[] args) {
        ...
        try {
            fos = new FileOutputStream(
                    "C:\\Users\\sauce\\Desktop\\Universidad\\Cuarto\\Segundo semestre\\DSS\\Jungla\\Almacen.dat");
            ...
            try {
                do {
                    ...
                    switch (flag1) {
                        case 1:
                            consultar_medicamento(A.getVector_medicamento());
                            break;
                        case 2:
                            realizar_compra(A.getVector_medicamento());
                            break;
                        case 3:
                            consultar_cliente(A1.getVector_cliente());
                            break;
                        case 4:
                            addMedicamento_Almacen(A);
                            break;
                        case 5:
                            A.mostrar_contenido_almacen();
                            break;
                        case 0:
                            break;
                    }
                ...
                switch (flag2) {
                    case 1:
                        try {
                            ...
                            System.out.println(
                                    "No se ha podido ejecutar bien el caso 1 de la funcion consultar_medicamento()");
                        }
                    ...
                    case 2:
                        try {
                            ...
                            System.out.println(
                                    "No se ha podido ejecutar bien el caso 2 de la funcion consultar_medicamento()");
                        }
                    ...
                    case 3:
                        try {
                            ...
                            System.out.println(
                                    "No se ha podido ejecutar bien el caso 3 de la funcion consultar_medicamento()");
                        }
            ...
            do {
                ...
                switch (flag1) {
                    case 1:
                        ...
                        break;
                    case 2:
                        eliminar_medicamento(c, v);
                        break;
                    case 3:
                        c.generateTicket_compra(); // Cambiar el txt a pdf
                        flag1 = 0;
                        break;
                    case 0:
                        cancelar_y_revertir_cambios(c, v);
                        break;
                }
                if (flag1 < 0 || flag1 > 3) {
                    System.out.println("No existe esa opcion, por favor vuelva a intentarlo");
